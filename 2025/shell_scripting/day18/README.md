...
2. **Strict mode** (`set -euo pipefail`) makes scripts safer and catches errors early
3. **Local variables** prevent unintended side effects
4. **Modular scripts** are easier to maintain and debug

---

## Next Steps

- Explore script debugging with `set -x`
- Learn about trap handlers for cleanup tasks
- Practice writing more complex shell utilities
